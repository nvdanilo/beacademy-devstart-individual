...
@section("body")
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn-outline-warning mb-3">
        ...
        <form action="{{ route('customers.destroy', $customer->id) }}" method="POST">
            @method("DELETE")
            @csrf
            <button type="submit" class="btn btn-outline-danger mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
